                ...
                <tr>
                    ...
                    <td class="text-center">
                        <p data-placement="top" data-toggle="tooltip" title="Delete">
                            <a class="btn btn-danger btn-xs" data-qty="{{ $laptop->quantity }}" data-id="{{ $laptop->id }}" data-toggle="modal"
                ...
                <div class="modal-body">
                    <form id="laptop-form" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary btn-lg" name="submit-laptop-form"
                                            id="submit-laptop-form">Submit
                                    </button>
                                </div>
                            </div>
                        </div>
